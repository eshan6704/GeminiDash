      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-mono">
        ...
        <div className={`p-4 rounded-xl border flex flex-col justify-between space-y-3 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] text-neutral-400">Alternative.me</span>
          </div>

          <div className="text-center py-2">
            <div className="text-4xl font-black tracking-tight text-amber-400 mb-1">
              {fearGreedValue} <span className="text-sm font-bold text-neutral-400">/ 100</span>
            </div>
            <span
          ...
          <p className="text-[11px] text-neutral-400 leading-relaxed font-sans">
            High greed indicates strong market momentum, though extreme greed can herald short-term leverage flushings.
          </p>
        </div>
